  ...
  return (
    <Suspense>
          ...
          <>
            ...
            <Switch>
              <Match when={!!props.title?.length}>
                ...
                <Meta property="og:image:alt" content={`${props.title} | ${defaultSeo.title}`} />
                <Meta property="og:title" content={`${props.title} | ${defaultSeo.title}`} />
              </Match>
              <Match when={!props.title}>
                <Title>{defaultSeo.title}</Title>
                <Meta property="og:title" content={defaultSeo.title} />
                <Meta property="og:image:alt" content={defaultSeo.title} />
              </Match>
            </Switch>
            ...
            <Meta name="keywords" content={[defaultSeo.keywords, props.keywords].flat().join(', ')} />
            ...
            <Switch>
              ...
              <Match when={defaultSeo.thumbnail} keyed>
                {(defaultThumbnail) => (
                  <>
                    <Meta
                      property="og:image"
      ...
      <Show when={env.publicHost}>
        ...
        <Meta property="og:url" content={env.publicHost + location?.pathname} />
      </Show>
    </Suspense>
  );
}
