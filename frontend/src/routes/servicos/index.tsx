...
export const route: RouteDefinition = {
  preload: async () => {
    return Promise.all([getServicesArchive(), getPaginatedServices(1, DEFAULT_PAGINATION_OFFSET), getSeoSettings()]);
  },
};
...
function Services() {
  ...
  const listSettings = createAsync(() => getServicesArchive(), { deferStream: true });
  ...
  return (
    <>
      <PageSeo
        ...
        keywords={[listSettings()?.title.toLowerCase() ?? 'serviços']}
      />
      <main>
